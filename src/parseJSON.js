  ...
  if (firstChar === '[') {
    ...
    if (jsonString.length === 0) {
      ...
      while (jsonString.length !== 0) {
        ...
        }  //else { //have to do else or it will execute this code, after getting value as an array, don't want that
        //but if include else the test suite fucking crashes... why?
